...
<div class="container mx-auto px-6 py-12 bg-gradient-to-br from-amber-50 to-orange-100 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-2xl min-h-screen">
    ...
    @if($cartItems->isEmpty())
        <p class="text-amber-600 dark:text-amber-400 text-center text-xl font-medium animate-pulse">Votre panier est vide. Ajoutez des burgers ! 🍔</p>
    @else
        <div class="space-y-8">
            ...
            <div class="text-right mt-10">
                ...
                <a href="{{ route('cart.checkout') }}" class="btn mt-6 px-8 py-4 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-all text-xl font-semibold shadow-lg">✅ Passer une commande !!!</a>
            </div>
        </div>
    @endif
</div>
